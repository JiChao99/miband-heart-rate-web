...
- 🌐 **双语支持** - 支持中文和英文界面切换
- 📺 **画中画模式** - 支持画中画显示心率数据
- 🎨 **多主题切换** - ECG心电图 / 赛博霓虹 / 玻璃拟态 / 运动环 / 像素复古 / 暗黑玻璃 / 蒸汽波（可快捷键切换 Ctrl+1..7）
...
| 主题 | 描述 | PiP 渲染 |
|------|------|----------|
| ECG 心电图 | 深色医疗监视器 + 绿色波形与网格 | 实时波形 + BPM 数字 |
| Cyber 赛博 | 霓虹渐变 + 扫描线 | 发光波形 + BPM |
| Glass 玻璃拟态 | 轻柔磨砂背景 | 居中大号数字 + BPM 标签 |
| Sport 运动环 | 深色背景 + 进度环 | 根据心率百分比动画圆环 |
| Pixel 像素复古 | 像素字体 + 复古深色背景 | 像素数字 + BPM |
| Dark Glass 暗黑玻璃 | 深色渐变 + 半透明磨砂面板 | 高对比度数字 + 面板描边 |
